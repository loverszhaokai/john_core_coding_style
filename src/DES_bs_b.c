...
#endif
{
	...
	for_each_depth_k() {
		...
		for (ic = 0; ic < 8; ic++) {
			DES_bs_vector *vp =
			    (DES_bs_vector *) & DES_bs_all.
			    xkeys.v[ic][0] DEPTH_K;
	LOAD_V FINALIZE_NEXT_KEY_BIT_0 FINALIZE_NEXT_KEY_BIT_1
			    FINALIZE_NEXT_KEY_BIT_2
			    FINALIZE_NEXT_KEY_BIT_3
			    FINALIZE_NEXT_KEY_BIT_4
			    FINALIZE_NEXT_KEY_BIT_5 FINALIZE_NEXT_KEY_BIT_6}}
#if DES_BS_EXPAND
	{
		int index;
...
start:
		...
		for_each_depth()
		    ...
		    y(30, 45), y(31, 46), y(0, 47), z(36), z(58), z(46), z(52));
...
swap:
		...
		for_each_depth()
		    ...
		    y(42, 63), y(43, 64), y(44, 65), z(23), z(15), z(29), z(5));
		for_each_depth()
		    s4(y(43, 66), y(44, 67), y(45, 68),
		    y(46, 69), y(47, 70), y(48, 71), z(25), z(19), z(9), z(0));
		for_each_depth()
		...
		for_each_depth()
		    ...
		    y(58, 87), y(59, 88), y(60, 89), z(31), z(11), z(21), z(6));
		for_each_depth()
		    s8(y(59, 90), y(60, 91), y(61, 92),
		    y(62, 93), y(63, 94), y(32, 95), z(4), z(26), z(14), z(20));
...
LOAD_V FINALIZE_NEXT_KEY_BIT_0 FINALIZE_NEXT_KEY_BIT_1
			    ...
			    FINALIZE_NEXT_KEY_BIT_6 FINALIZE_NEXT_KEY_BIT_7}}}
#undef v1
#undef v2
#undef v3
#undef v5
